...
Coins _$CoinsFromJson(Map<String, dynamic> json) {
  return Coins$.fromJson(json);
}

/// @nodoc
class _$CoinsTearOff {
  const _$CoinsTearOff();
  ...
  Coins fromJson(Map<String, Object?> json) {
    return Coins.fromJson(json);
  }
}

/// @nodoc
const $Coins = _$CoinsTearOff();
...
mixin _$Coins {
  ...
  @JsonKey(ignore: true)
  $CoinsCopyWith<Coins> get copyWith => throw _privateConstructorUsedError;
}
...
/// @nodoc
class _$CoinsCopyWithImpl<$Res> implements $CoinsCopyWith<$Res> {
  _$CoinsCopyWithImpl(this._value, this._then);

  final Coins _value;
  // ignore: unused_field
  final $Res Function(Coins) _then;
...
/// @nodoc
@JsonSerializable()
class _$Coins$ implements Coins$ {
  const _$Coins$(
      {this.id = ' ',
      this.symbol = ' ',
      this.name = ' ',
  ...
  Map<String, dynamic> toJson() {
    return _$$Coins$ToJson(this);
  }
}

abstract class Coins$ implements Coins {
  const factory Coins$(
      {String id,
      String symbol,
      String name,
